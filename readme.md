...
ii.add text in div -> NewDiv.innerText = "Hello Programming Hero "
iii.add or insert in page -> document.body.appendChild(newDiv);
We can make a new element like this <div> example that i given up.
 -->
